...
join_set1 = np.genfromtxt('./data/MovieLens1M/MLFK1.csv', skip_header=True, dtype=int)
r1 = mmread('./data/MovieLens1M/MLR1Sparse.txt',)

join_set2 = np.genfromtxt('./data/MovieLens1M/MLFK2.csv', skip_header=True, dtype=int)
r2 = mmread('./data/MovieLens1M/MLR2Sparse.txt',)

Y = np.matrix(np.genfromtxt('./data/MovieLens1M/MLY.csv', skip_header=True, dtype=float)).T
